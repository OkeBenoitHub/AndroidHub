...
class SharedPrefUtil @Inject constructor() {
    ...
    /**
     * Write string data to shared preferences
     * @param context :: context
    ...
    /**
     * Write int data to shared preferences
    ...
    /**
     * Write boolean data to shared preferences
    ...
    /**
     * Get boolean data from shared preferences
     * @param keyValue :: key for preference
     * @return boolean data
     */
    ...
    /**
     * Write array list data to shared preferences
    ...
    /**
     * Get array list data from shared preferences
     * @param keyValue :: key for preference
    ...
    /**
     * Delete a specific data from shared preference by key value
